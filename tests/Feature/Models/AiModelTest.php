...
it('can have multiple providers', function () {
    $ollama = AiModel::factory()->create(['provider' => 'ollama', 'model_id' => 'llama3:8b']);
    $groq = AiModel::factory()->create(['provider' => 'groq', 'model_id' => 'llama-3.1-70b']);
    $openai = AiModel::factory()->create(['provider' => 'openai', 'model_id' => 'gpt-4']);
    $anthropic = AiModel::factory()->create(['provider' => 'anthropic', 'model_id' => 'claude-3-opus']);
...
it('scopes to enabled models only', function () {
...
it('scopes to models supporting tools', function () {
...
it('scopes to models supporting vision', function () {
...
it('scopes by speed tier', function () {
...
it('has unique provider and model_id combination', function () {
