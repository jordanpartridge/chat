...
describe('model name validation', function () {
...
describe('casts generation', function () {
...
describe('relationship generation', function () {
...
describe('migration schema generation', function () {
